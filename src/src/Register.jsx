...
// Se você não tiver o arquivo api.js dentro de uma pasta lib, pode descomentar a linha abaixo ou ignorar o erro se o api não for usado
...
export default function Register() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      // Caso a função formatError não esteja pronta, usamos uma mensagem padrão de erro
